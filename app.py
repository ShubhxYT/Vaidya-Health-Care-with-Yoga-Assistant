    ...
    def run(self):
        ...
        with st.sidebar:
            app = option_menu(
                ...
                options=['Home', 'Login', 'Profile', 'Health Overview','Lumi AI', 'Prediction Models','Report Analysis', 'AI Coach', 'Connect with Doctor', 'Hospital Locator'],
                default_index=0,
            )
