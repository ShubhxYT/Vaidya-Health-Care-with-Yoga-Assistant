...
# Set paths
DATA_DIR = "Prediciton models/skin_disease_prediciton/img"  # Update to your image directory
MODEL_PATH = "Prediciton models/skin_disease_prediciton/models/skin_disease.pth"  # Update to your trained model path
