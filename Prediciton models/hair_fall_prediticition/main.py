...
# Set paths
DATA_DIR = "Prediciton models/hair_fall_prediticition/img"  # Update to your test image directory
MODEL_PATH = "Prediciton models/hair_fall_prediticition/models/hair_classification.pth"  # Update to your trained model path
